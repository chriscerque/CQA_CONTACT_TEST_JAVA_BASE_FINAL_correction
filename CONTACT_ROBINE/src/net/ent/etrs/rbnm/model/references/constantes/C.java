 ...
 * 
 */
package net.ent.etrs.rbnm.model.references.constantes;
...
public class C {
	...
	public static final String MSG_MAIL_EXCEPTION_NULL = "Le type de mail doit être renseigné.";
	public static final String MSG_TELEPHONE_EXCEPTION_NULL = "Le type de numéro de téléphone doit être renseigné";
	...
	public static final String MSG_CONTACT_SUPPRESSION_COORDONNEE_EXCEPTION = "La suppression d'un coordonnée pour un contact n'a pu aboutir.";
	public static final String MSG_CONTACT_COORDONNEE_EXIST = "Le coordonnée indiqué existe déjà.";
	public static final String MSG_CONTACT_COORDONNEE_AJOUT = "L'ajout du coordonnées pour le contact n'a pas pu être effectué car il existe déjà.";
	public static final String MSG_CONTACT_COORDONNEE_SUPPR = "Impossible de supprimé le coordonnées car il n'existe pas. ";
	public static final String MSG_CONTACT_COORDONNEE_NONEXIST = "Le coordonnée indiqué n'existe pas.";
