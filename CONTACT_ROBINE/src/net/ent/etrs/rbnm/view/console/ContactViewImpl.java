...
import net.ent.etrs.rbnm.model.commons.outils.LectureConsole;
import net.ent.etrs.rbnm.model.comparator.TypeCoordonneeComparator;
import net.ent.etrs.rbnm.model.comparator.TypeNumeroComparator;
import net.ent.etrs.rbnm.model.entities.*;
...
public class ContactViewImpl implements ContactView {
    ...
    public Contact saisirContact() throws ContactException {
        ...
        Contact c = FactoryMetier.fabriquerContact(nom, prenom, dateNaissance);
    ...
    private Coordonnee saisirCoordonneesContactMail(final Contact contact) throws CoordonneeException {
        ...
        return FactoryMetier.fabriquerMail(contact, adresseMail, typeMail);
    }
    ...
    private Coordonnee saisirCoordonneesContactTelephone(final Contact contact) throws CoordonneeException {
        ...
        return FactoryMetier.fabriquerTelephone(contact, numero, typeNumero);
    }
