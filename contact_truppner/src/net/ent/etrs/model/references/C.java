...
public class C {
	...
	public static final String TITRE_AFFICHAGE_CONTACTS = "\n              - LISTE CONTACTS - ";

	public static final String MSG_FM_NULL = "FacadeMetier NULL...";
	public static final String MSG_CV_NULL = "ContactViewImpl NULL...";
	public static final String MSG_MV_NULL = "MailViewImpl NULL...";
	public static final String MSG_TV_NULL = "TelephoneViewImpl NULL...";
	...
	public static final String MSG_CONTACT_CREATION = "Le contact a été créé.";
	public static final String MSG_CONTACT_SUPPRESSION = "Le contact a été supprimé.";
	public static final String MSG_CONTACT_MISE_A_JOUR = "Le contact a été mis à jour.";
	...
	public static final String MSG_COORDONNEE_CREATION_EXCEPTION = "Le contact est non renseigné.";
	public static final String MSG_COORDONNEE_SUPPRESSION_EXCEPTION = "Le contact est non renseigné.";
	public static final String MSG_COORDONNEE_TYPE = "Type de coordonnée non renseigné.";

	public static final String MSG_TELEPHONE_EXCEPTION = "Erreur sur le telephone.";
	public static final String MSG_TELEPHONE_NUMERO_INEXISTANT_EXCEPTION = "Le numero de téléphone est inexistant";
	public static final String MSG_TELEPHONE_NUMERO_EXISTANT_EXCEPTION = "Le numero de téléphone existe déjà";
	public static final String MSG_NUMERO_NULL = "Le numero n'est pas renseigné.";
	public static final String MSG_TYPE_NUMERO = "Le type de numero n'est pas renseigné.";

	public static final String MSG_MAIL_EXCEPTION = "Erreur sur le mail.";
	public static final String MSG_EMAIL_INVALIDE = "L'adresse mail n'est pas valide";
	public static final String MSG_MAIL_EXISTANT_EXCEPTION = "L'adresse mail existe déjà";
	public static final String MSG_MAIL_INEXISTANT_EXCEPTION = "L'adresse mail est inexistante";
	public static final String MSG_MAIL_TYPE = "Type de mail non renseigné.";
	public static final String MSG_MAIL_NULL = "Adresse mail non renseignée.";

	//DAO
	public static final String MSG_CONTACT_CREATION_EXCEPTION = "La sauvegarde du contact n'a pas pu être effectuée.";
	public static final String MSG_CONTACT_SUPPRESSION_EXCEPTION = "La suppression du contact n'a pas pu être effectuée.";
	public static final String MSG_CONTACT_MISE_A_JOUR_EXCEPTION = "La mise à jour du contact n'a pas pu être effectuée.";
