...
public abstract class AbstractContactDao implements IDao<Contact, String> {
	...
	public void init() {
		...
		try {
			...
			Coordonnee cm1 = EntitiesFactory.fabriquerMail(miney, TypeMail.PERSONNEL, "bernard.miney@dorothe.com");
			Coordonnee cm2 = EntitiesFactory.fabriquerMail(miney, TypeMail.PERSONNEL, "bernardm@free.fr");
			Coordonnee cm3 = EntitiesFactory.fabriquerMail(miney, TypeMail.PROFESSIONNEL, "b.m@def.fr");
			Coordonnee cm4 = EntitiesFactory.fabriquerMail(miney, TypeMail.PROFESSIONNEL, "b.m1@def.fr");
