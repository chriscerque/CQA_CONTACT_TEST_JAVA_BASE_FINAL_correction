...
public class C {
	...
	public static final String MSG_CONTACT_DATE_NAISSANCE_FORMAT_EXCEPTION = "La date de naissance n'est pas au bon format.";
	...
	public static final String MSG_FACADE_METIER_NULL = "ERR FACADE METIER (contact).";
	public static final String MSG_FACADE_VUE_NULL = "ERR FACADE VUE.";


	public static final String MSG_QUITTER = "\n Vous venez de quitter le programme.";
