...
public class C {
	...
	// Dao Generic
	public static final String DAO_EXIST_EXCEPTION = "Dao : l'instance existe déjà";
	public static final String DAO_EXIST_PAS_EXCEPTION = "Dao : l'instance n'existe pas";
