...
public abstract class AbstractContactDao extends DaoGeneric<Contact, String> implements IContactMemDao {
	...
	public void init() {
		...
		} catch (DaoException | ContactException | CoordonneeException e) {
