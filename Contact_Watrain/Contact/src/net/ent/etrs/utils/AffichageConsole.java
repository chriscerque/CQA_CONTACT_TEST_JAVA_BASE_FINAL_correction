...
public final class AffichageConsole {
	 ...
	 * Si le pattern est invalide, la date sera affichée selon le pattern défini
	 * par défaut.
...
//	}
	 ...
	 *
	 * @param options
	 *            List de chaînes de caractères à traiter.
	 */
	 ...
	 *
	 * @param options
	 *            Map contenant en clé le numéro de l'option et en valeur la
	 ...
	 *
	 * @param options
	 *            Tableau de chaînes de caractères à traiter.
	 * @param libelleSortie
	 *            Libelle à écrire en regard de l'option de sortie 0.
	 */
	 ...
	 *
	 * @param options
	 *            Liste de chaînes de caractères à traiter.
	 * @param nomMenu
	 *            Libellé du menu.
	 */
	 ...
	 * @return
	 * nombre de caractères composant la chaîne la plus longue.
	 */
	 ...
	 * </pre>
	 * @param numeroOption
	 * numéro de l'option (1 dans l'exemple).
