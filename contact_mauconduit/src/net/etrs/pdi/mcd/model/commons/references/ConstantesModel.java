package net.etrs.pdi.mcd.model.commons.references;
...
public final class ConstantesModel {
	...
	public static final String ERR_MODEL_NULL = "Le metier renseigné n'existe pas ou n'a pas été initialisé !";
	public static final String ERR_VIEW_NULL = "La vue renseigné n'existe pas ou n'a pas été initialisé !";
