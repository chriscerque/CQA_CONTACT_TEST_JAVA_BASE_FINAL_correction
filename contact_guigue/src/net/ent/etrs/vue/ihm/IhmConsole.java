...
import net.ent.etrs.vue.ihm.outils.IhmOutils;
...
public class IhmConsole implements Ihm {
     ...
     * puis utilise la méthode {@link int[] rechercherMaxDsColonne} pour obtenir un tableau d'entier contenant la longueur de chaque colonne
     *
