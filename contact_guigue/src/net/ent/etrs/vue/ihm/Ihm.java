package net.ent.etrs.vue.ihm;


import net.ent.etrs.vue.exceptions.ExceptionsIhm;
import net.ent.etrs.vue.ihm.referencies.TypeAlignement;

import java.time.LocalDate;

/**
 * Interface définissant le contrat pour les affichages/IHM.
 */
public interface Ihm{
    ...
    /**
     * Méthode chargée de réaliser la saisie d'un entier dans [min]
     *
     * @param msg String
     * @param min int, le choix mini
     * @return int
    ...
    /**
     * Méthode chargée de réaliser la saisie d'un entier dans [max]
     *
     * @param msg String
     * @param max int, le choix maxi
     * @return int
     ...
     */
    public int saisirChoixMenu(String[] tabloStr) throws ExceptionsIhm;
     ...
     *
     * @param titre String titre du menu ou de l'application
     * @param str String[] tableau contenant les différentes lignes du menu
     * @return int retourne le choix du menu
     */
    public int saisirChoixMenuPrincipal(String titre, String[] str);
