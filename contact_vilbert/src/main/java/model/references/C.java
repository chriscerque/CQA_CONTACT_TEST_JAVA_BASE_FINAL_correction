...
public class C {
	...
	public static final String MSG_CONTACT_DATE_NAISSANCE_INVALIDE_FORMAT_EXCEPTION = "La date de naissance n'est pas au bon format";
	...
	public static final String MSG_TELEPHONE_INVALIDE = "Le téléphone %s n'est pas valide";
	...
	public static final String MSG_DAO_LECTURE_CONTACT_INEXISTANT = "Dao : tentative de lecture d'un contact inexistant";
