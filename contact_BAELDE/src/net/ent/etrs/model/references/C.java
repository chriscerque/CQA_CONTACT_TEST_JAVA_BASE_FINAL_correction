...
public class C {
	...
	public static final String MSG_COORDONNEE_TYPE_NULL_EXCEPTION = "Le type est non renseigné.";
	...
	public static final String MSG_MAIL_INVALIDE = "L'adresse mail %s n'est pas valide";
	...
	//DAO
	public static final String MSG_CONTACT_INEXISTANT = "Le contact recherché n'existe pas.";
