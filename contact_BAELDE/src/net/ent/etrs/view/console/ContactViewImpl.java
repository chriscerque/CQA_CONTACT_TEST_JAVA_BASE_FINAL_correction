...
public class ContactViewImpl implements ContactView {
    ...
    public void afficherContacts(final List<Contact> lstContacts) {
        List<Contact> contactsTries = new ArrayList<>(lstContacts);
        Collections.sort(contactsTries, new ContactComparator());
//        lstContacts.forEach(c -> this.afficherContact(c));
        for (Contact c : lstContacts) {
            this.afficherContact(c);
        }
    }
